...
function PerformDetail() {
  ...
  return (
    <div className="flex flex-col items-center">
      {modalOpen && <Modal modalOpen={modalOpen} onClose={closeModal} />}
      <div className="w-10/12">
        ...
        <div className="flex mt-32">
          ...
          <div className="w-4/5 pt-10 pl-10 h-96 border-solid border-2 border-gray-400 rounded flex flex-col items-center">
            <div className="text-xl w-full mb-10">OOO 공연</div>
            <div className="w-11/12 flex text-base">
              ...
              <div className="mx-16">
                <p className="my-1">abc123</p>
                <p className="my-1">www.aaaa.aaa</p>
              </div>
            </div>
            <div className="mt-20 flex">
              <Link to="register">
                <button className="w-28 h-8 bg-[#689F38] flex text-white rounded mx-2 font-bold justify-between items-center">
                  <svg
